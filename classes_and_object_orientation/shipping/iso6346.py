...
def create(owner_code, serial, category='U'):
    ...
    Returns: An ISO 6346 container code including a check digit.
    ...
    if not (len(serial) == 6 and serial.isdigit()):
        raise ValueError(f'Invalid ISO 6346 serial identifier {serialy}')
...
def code(char):
    ...
    Args:
        char(str): A simple character string.
    Return:
